...
def draw_result_img(img_disp, ith_img, humans, dict_id2skeleton,
    ...
    #         print("BodyPart_" + str(i))

    #     #     x1 = humans[0].body_parts[i].x
    #     #     y1 = humans[0].body_parts[i].y

    #     #     position_list.append(x1)
    #     #     position_list.append(y1)

    #     #     print(humans[0].body_parts[i].x)
    #     #     print(humans[0].body_parts[i].y)
    #     # part_list.append(position_list)

    

    # here is your positions..you can do anything with it now.. 
    x0y0 = (humans[0].body_parts[0].x, humans[0].body_parts[0].y)
    x1y1 = (humans[0].body_parts[1].x, humans[0].body_parts[1].y)
    x2y2 = (humans[0].body_parts[2].x, humans[0].body_parts[2].y)
    x5y5 = (humans[0].body_parts[5].x, humans[0].body_parts[5].y)

        
    #print("______________distance____________")
    #print(geodesic(x0y0,  x1y1))
    #print(geodesic(x2y2,  x5y5))
...
if __name__ == "__main__":
    ...
    try:
        ...
        while images_loader.has_image():
            ...
            # -- Detect skeletons
            humans = skeleton_detector.detect(img)#detects the coordinates
